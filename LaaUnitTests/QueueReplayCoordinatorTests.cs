...
//
//         var coordinator = new QueueReplayCoordinator(_queueMock.Object, _connectivityMock.Object);
//
//         // Allow background thread from Task.Run to execute
//         Thread.Sleep(100);
//
...
//         var coordinator = new QueueReplayCoordinator(_queueMock.Object, _connectivityMock.Object);
//
//         // Transition online first time - starts processing and waits on tcs
//         _connectivityMock.Setup(conn => conn.IsOffline).Returns(false);
//         _connectivityMock.Raise(conn => conn.ConnectivityChanged += null, _connectivityMock.Object, ConnectivityStatus.Online);
//
//         Thread.Sleep(50);
//
//         // Transition online second time - should be blocked by guard
//         _connectivityMock.Raise(conn => conn.ConnectivityChanged += null, _connectivityMock.Object, ConnectivityStatus.Online);
//
//         Thread.Sleep(50);
//
//         // Complete the task and allow loop to finish
//         tcs.SetResult(true);
//         Thread.Sleep(50);
//
//         _queueMock.Verify(q => q.ProcessQueueAsync(It.IsAny<CancellationToken>()), Times.Once);
